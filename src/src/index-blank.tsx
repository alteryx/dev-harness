...
import { AyxAppWrapper, Box, Grid, Typography, makeStyles } from '@ayx/eclipse-components';
...
const useStyles = makeStyles(() => ({
  stripes: {
    height: '100vh',
    background: 'repeating-linear-gradient(45deg, #606dbc, #606dbc 20px, #465298 10px, #465298 40px);'
  }
}));
...
const App = () => {
  ...
  return (
    <Box p={4} className={demoStripes ? classes.stripes : undefined} onClick={() => handleStripes(!demoStripes)}>
      {!demoStripes ? <Grid container spacing={10} direction="column" alignItems="center">
        <Grid item>
