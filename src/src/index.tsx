...
import { AyxAppWrapper, Typography, Grid } from '@ayx/ui-core';
        ...
        <Grid container spacing={10}>
          <Grid item xs={12}>
            <Grid container justify="center">
              <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" height="240" width="240" viewBox="0 0 155.92 172">
                <title>logo_alteryx_a</title>
