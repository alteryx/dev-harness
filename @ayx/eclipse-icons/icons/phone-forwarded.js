...
var PhoneForwarded = _react.default.forwardRef(function PhoneForwarded(props, ref) {
...
PhoneForwarded.propTypes = process.env.NODE_ENV !== "production" ? {
...
PhoneForwarded.name = PhoneForwarded.render.name || 'PhoneForwarded';
