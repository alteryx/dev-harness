...
var PhoneIncoming = _react.default.forwardRef(function PhoneIncoming(props, ref) {
...
PhoneIncoming.propTypes = process.env.NODE_ENV !== "production" ? {
...
PhoneIncoming.name = PhoneIncoming.render.name || 'PhoneIncoming';
