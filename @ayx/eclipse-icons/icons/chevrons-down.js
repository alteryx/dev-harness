...
var ChevronsDown = _react.default.forwardRef(function ChevronsDown(props, ref) {
...
ChevronsDown.propTypes = process.env.NODE_ENV !== "production" ? {
...
ChevronsDown.name = ChevronsDown.render.name || 'ChevronsDown';
