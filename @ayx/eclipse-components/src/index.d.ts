...
import { Theme as MTheme } from '@material-ui/core/styles/createMuiTheme';

import { Palette } from './styles/createPalette';
 ...
 * `style`.
 */
export type StandardProps<C, ClassKey extends string, Removals extends keyof C = never, AcceptsRef = true> = Omit<
  C,
  'classes' | Removals
> &
...
export { default as IntlProviderWithArrows, padMessages } from './IntlProviderWithArrows';
...
export { RadioGroupState } from './RadioGroup';
...
export { useFormControl } from './FormControl';
