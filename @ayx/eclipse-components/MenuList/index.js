...
var _ownerDocument = _interopRequireDefault(require("@material-ui/core/utils/ownerDocument"));

var _useForkRef = _interopRequireDefault(require("@material-ui/core/utils/useForkRef"));

var _getScrollbarSize = _interopRequireDefault(require("@material-ui/core/utils/getScrollbarSize"));
...
var MenuList = /*#__PURE__*/React.forwardRef(function MenuList(props, ref) {
  var actions = props.actions,
      ...
      other = (0, _objectWithoutProperties2.default)(props, ["actions", "autoFocus", "autoFocusItem", "children", "className", "disabledItemsFocusable", "disableListWrap", "isSubMenu", "onKeyDown", "variant"]);
  ...
  var handleKeyDown = function handleKeyDown(event) {
    ...
    var capturedKeys = ['ArrowDown', 'ArrowUp', 'Home', 'End'];
...
MenuList.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   * @ignore
   */
  isSubMenu: _propTypes.default.bool,
...
var _default = (0, _utils.dataUICMaker)(MenuList, 'MenuList');
